import logging
from data_provider.utils_dataset import download
import pandas as pd
import os
...
SubDataset = ['FOOD1', 'FOOD2', 'FOOD3','MANU', 'PHAR1', 'PHAR2', 'OFFICEh','OFFICEm','ETTh1','ETTh2','ETTm1','ETTm2','ECL']
...
def data_provider_electricity(args, flag):
    """
    Provide Electricity data. list:['FOOD1', 'FOOD2', 'FOOD3','MANU', 'PHAR1', 'PHAR2', 'OFFICEh','OFFICEm','ETTh1','ETTh2','ETTm1','ETTm2','ECL']
    """

    data_path, dataset_path = download(args.dataset)
